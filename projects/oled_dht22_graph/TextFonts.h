...
* File: TextFonts.h
* Description: 3 font pixel ASCII font
 PICO (4 by 6) UNO (6 by 8) MEGA (16 by 16)  
 also includes image file for image test in main.c 
 used in Oled graphics I2C project at URL
* Author: Gavin Lyons.
...
const uint8_t MEGA[] = {   // Size is 16x16 (NB 0x10 = 16 decimal)  
0x10,0x10,0x20,0x5F,
...
// 'myimage', 128x64px "g lyons" + shapes , SW used to make https://javl.github.io/image2cpp/
